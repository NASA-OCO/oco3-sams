...
Our project has our licensing terms, including rules governing redistribution, documented in our [LICENSE](LICENSE.txt) file. Please take a look at that file and ensure you understand the terms. This will impact how we, or others, use your contributions.
...
- Issue tracking system - submit an Issue in this GitHub repository to report issues with our software or propose changes.
- Discussion board - start a new Discussion in this GitHub repository to hold conversations related to our project, and to propose as well as show+tell topics to the contributor team. This resource can be searched for old discussions.

## Our Development Process

Our project integrates contributions from many people, and so we'd like to outline a process you can use to visualize how your contributions may be integrated if you provide something. Note that any proposed changes are still subject to approval as outlined in [GOVERNANCE.md](GOVERNANCE.md).
...
Make sure people are aware you're working on a patch! Check out our repositories Issues are and find an open issue you'd like to work against, or alternatively file a new issue and mention you're working on a patch.
...
Within your local development environment, this is the stage at which you'll propose your changes, and commit those changes back to version control.
...
Navigate to the Issues area of this repository to create a new Issue or see existing ones.
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the repository's Issues area first.

Here's some guidance on submitting a bug issue:
1. Navigate to our repository's Issues area and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the repository's Issues area first
...
Report your security vulnerabilities to [Brian Knosp](https://github.com/brian-knosp).
...
Take a look at our repository's Pull Request area, and try the following options for providing a review:
...
⚠️ It's **highly** advised that you take a look at our repository's Issues area before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our repository's Issues area before considering any documentation contributions. Here's some guidelines:
...
- Source-controlled documentation
  ...
  - [GOVERNANCE.md](GOVERNANCE.md) - transparent governance model for the project 
...
- **OCO-3** - acronym, all capital letters with a hyphen
- **SAM** - acronym, all capital letters
...
- Answer open questions in our repository's Discussions area
- Answer open questions mentioned in our repository's Issues area
